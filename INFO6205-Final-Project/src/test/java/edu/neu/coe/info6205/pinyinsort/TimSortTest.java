...
public class TimSortTest {
    ...
    @Test
    public void sort2() {
        String[] words = ChangeToEn.getWords("/shuffledChinese.txt", ChangeToEn::lineAsList, TimSortTest.class);
        String[] res = TimSort.sort(words);
        String[] sorted = Arrays.copyOfRange(res, 0, 1000000);
        ChangeToEn.writeWords(sorted, String.join(File.separator, "src", "main", "resources", "TimSort_Result.txt"));
