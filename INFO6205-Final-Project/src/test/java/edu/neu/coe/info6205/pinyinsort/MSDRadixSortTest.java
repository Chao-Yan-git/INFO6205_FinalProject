...
public class MSDRadixSortTest {
    ...
    @Test
    public void sort1() {
        String[] res = MSDRadixSort.sort(input);
    ...
    public void sort2() {
        ...
        String[] res = MSDRadixSort.sort(words);
        String[] sorted = Arrays.copyOfRange(res, 0, 1000000);
        ChangeToEn.writeWords(sorted, String.join(File.separator, "src", "main", "resources", "MSDSort_Result.txt"));
