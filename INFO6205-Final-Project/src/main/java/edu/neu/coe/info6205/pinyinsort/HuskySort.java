...
public class HuskySort<X extends Comparable<X>> {
    ...
    CollatorHelper<X> helper = new CollatorHelper<>("Helper");
     ...
     */
    public HuskySort(final HuskyCoder<X> huskyCoder, final boolean mayBeSorted, final boolean useInsertionSort) {
