 ...
 */
public class DualPivotQuickSort<X extends Comparable<X>> extends QuickSort<X> {
    ...
    public Partitioner<X> createPartitioner() {
        return new DualPivotQuickSort.Partitioner_DualPivot(getHelper());
    }

    public DualPivotQuickSort(final String description, final int N, final Config config) {
     ...
     */
    public DualPivotQuickSort(final Helper<X> helper) {
        super(helper);
        setPartitioner(createPartitioner());
    }
     ...
     */
    public DualPivotQuickSort(final int N, final Config config) {
    ...
    public static String[] sort(String[] xs) {
        final CollatorHelper<String> helper = new CollatorHelper<>("Helper");
        QuickSort<String> sr = new DualPivotQuickSort<>(helper);
        return sr.sort(xs);
    }
